...
/**
 * Spring Data Mongo Repository implementation to provide the basic mongo based
 * operations on a domain object
 *
 * @author: Y Kamesh Rao
...
public abstract class BaseMongoCrudRepository<T extends MongoEntity<?>, ID extends Serializable>
	...
	public Iterable<T> saveAll(Iterable<? extends T> entities) {
