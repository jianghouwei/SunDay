...
public class PermissionController extends BaseWebAppController{
	...
	public List<Permission> getData() {
		List<Permission> permissionList=(List<Permission>) permissionService.findAll();
		return permissionList;
	}
	...
	public Map<String, Object> menuOperationDate(Integer pid){
		List<Permission> menuOperList=permissionService.findPermissions(pid);
	...
	public List<Permission> otherPermissionDate(@PathVariable("userId") Integer userId) {
		List<Permission> permissionList=permissionService.findPermissions(userId);
		return permissionList;
	}
